...
export default function Unread(props,{addToFav,AddedCart}) {
  ...
  return (
    ...
    <Card className='youuu'>
          <Card.Img variant="top" src='https://avatars.dzeninfra.ru/get-zen_doc/9759668/pub_645541f832e3665fb212d146_64554346f20fcc6a45ddc5cd/scale_1200' className='photo'/>
          <Card.Body>
            <div className='yourr'>
            <Card.Title className='glavv'><h3>Паста Карбонара</h3></Card.Title>
            </div>
            <Card.Text>
    ...
    <Card className="cardsfloat">
      <Card.Body className="textcards">Рецепт:спагетти, бекон, яйца, сыр пармезан, масло сливочное, масло оливковое, чеснок, вода, соль, перец чёрный молотый</Card.Body>
    </Card>
