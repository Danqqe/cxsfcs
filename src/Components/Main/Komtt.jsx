...
export default function Unread(props,{addToFav,AddedCart}) {
  ...
  return (
    ...
    <Card className='youuu'>
          <Card.Img variant="top" src='http://klublady.ru/uploads/posts/2022-02/1644978651_1-klublady-ru-p-tort-tiramisu-foto-1.jpg' className='photo'/>
          <Card.Body>
            <div className='yourr'>
            <Card.Title className='glavv'><h3>Тирамису</h3></Card.Title>
            </div>
            <Card.Text>
    ...
    <Card className="cardsfloat">
      <Card.Body className="textcards">Рецепт:печенье бисквитное, сыр маскарпоне, яйца, пудра сахарная, кофе, вино десертное, ликер кофейный, какао-порошок</Card.Body>
    </Card>
